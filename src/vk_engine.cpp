...
void VulkanEngine::init()
{
	...
	_PipelineLayouts.push_back({});
	initPipelineLayouts(&_PipelineLayouts[1], vkinit::pipelineLayoutCreateInfo());
...
void VulkanEngine::initPipelineLayouts(PipelineLayout* const lay, VkPipelineLayoutCreateInfo& pipelineLayoutInfo) {
	if ((lay->_pipelineLayout) == VK_NULL_HANDLE)	// default layout, if nothing
	{
